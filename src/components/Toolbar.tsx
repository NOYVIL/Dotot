      ...
      <div className="mt-6 flex flex-col gap-3">
        <div className="flex gap-3">
          <button
            ...
            onClick={onUndo}
            disabled={!canUndo}
            className="flex-1 cursor-pointer rounded border border-[#2A2A2E] bg-zinc-800 px-2 py-3 text-[12px] font-bold uppercase tracking-[0.05em] text-white transition-all active:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-40" 
          >
            Undo
          </button>
          <button
