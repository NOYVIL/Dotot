      ...
      <div className="mt-6 flex flex-col gap-3">
        <div className="flex gap-3">
          ...
          <button
            ...
            onClick={onClear}
            disabled={!canUndo}
            className="flex-1 cursor-pointer rounded border border-[#2A2A2E] bg-zinc-800 px-2 py-3 text-[8px] font-bold uppercase tracking-[0.05em] text-red-400 transition-all hover:text-red-300 active:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Clear
          </button>
        </div>
        <button
          type="button"
          onClick={onPrint}
          className="w-full cursor-pointer rounded bg-white px-4 py-3 text-[8px] font-bold uppercase tracking-[0.05em] text-zinc-900 shadow-lg transition-all active:bg-zinc-200"
        >
          Print
        </button>
      </div>
